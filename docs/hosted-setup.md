...
Approved preparation
  ...
  -> Anthropic source-bound selection for a complete one-to-two-page CV
  -> deterministic source, claim, completeness, and page-limit audit
  -> ATS-readable styled PDF rendering
